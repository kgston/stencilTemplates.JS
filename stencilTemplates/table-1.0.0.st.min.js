...
[];this.dataset.global={};this.dataset.tableSelector=null;return this},clearAll:function(){this.dataset={global:{},tableID:r,css:m,style:q,headers:[],rowSets:[]}},render:function(a){if(null==p.table.stencil)p.table.templateLoader.done(function(){this.render(a)}.bind(this));else{var b=this,c=this.dataset,e=this.update,d=c.tableSort,g=c.tableSearch,f=c.tablePaginate,r=c.tableRowsDisplayed,k=c.tableSelector,h=stencilTemplates.util.cloneJSON(c),l=function(a,b){var c=0;this.columnIndexes.every(function(d,
e){var f=this.sortFlow[e];c=a.rows[0].rowColumns[d].content<b.rows[0].rowColumns[d].content?-1*f:a.rows[0].rowColumns[d].content>b.rows[0].rowColumns[d].content?1*f:0;return 0===c?!0:!1},this);return c}.bind(d);if(null!=g){for(var n=g.lastSearchTerm.split(" ");0<=n.indexOf("");)n.splice(n.indexOf(""),1);n.forEach(function(a,b){n[b]=new RegExp(a,"i")});if(0!==n.length)for(var m=0;m<h.rowSets.length;m++){var t=!1;h.rowSets[m].rows.every(function(a,b){if(null==g.searchRowIndexes||0<=g.searchRowIndexes.indexOf(b))a.rowColumns.every(function(a,
b){if(null==g.searchColumnIndexes||0<=g.searchColumnIndexes.indexOf(b)){var w=0;n.forEach(function(b){0<=a.content.toString().search(b)&&w++});w===n.length&&(t=!0)}else return!0;return!t});else return!0;return!t});t||(h.rowSets.splice(m,1),m--)}}null!=d&&0<d.columnIndexes.length&&(d.columnIndexes.forEach(function(a,b){h.headers[h.headers.length-1].headerColumns[a].sortIcon={css:1===d.sortFlow[b]?"st-tableSortUp":"st-tableSortDown"}}),h.rowSets.sort(l));if(null!=f){l=!1;do{var l=!1,q=[],u=0,v=1;f.currentPage>
f.totalPages?(f.currentPage=f.totalPages,h.tablePaginate.currentPage=f.totalPages):1>f.currentPage&&(f.currentPage=1,h.tablePaginate.currentPage=1);h.rowSets.forEach(function(a){u+=a.rows.length;u>f.rowsPerPage&&(v++,u=a.rows.length);v===f.currentPage&&q.push(a)});f.totalPages=v;h.tablePaginate.totalPages=v;1===f.currentPage&&(h.tablePaginate.prevPageStyle="visibility: hidden; ");f.currentPage===h.tablePaginate.totalPages&&(h.tablePaginate.nextPageStyle="visibility: hidden; ");f.currentPage>h.tablePaginate.totalPages?
l=!0:h.rowSets=q}while(l)}l=p.table.stencil.render(h,"fragment");if(null!=d){var x=function(a){var b=this.tableSort;a=$(a);a=a.index();0>b.columnIndexes.indexOf(a)?(b.allowMultipleColumns||(b.columnIndexes=[],b.sortFlow=[]),b.columnIndexes.push(a),b.sortFlow.push(1)):b.sortFlow[b.columnIndexes.indexOf(a)]*=-1}.bind(c),y=function(a){var b=this.tableSort;a=$(a);a=a.index();if(0<=b.columnIndexes.indexOf(a)){var c=b.columnIndexes.indexOf(a);b.columnIndexes.splice(c,1);b.sortFlow.splice(c,1);delete this.headers[this.headers.length-
1].headerColumns[a].sortIcon}}.bind(c);l.find(".st-tableHeader").last().find(".st-tableHeaderColumns").each(function(a){if(null==d.limitSortColumns||null!=d.limitSortColumns&&0<=d.limitSortColumns.indexOf(a))this.onclick=function(){x(this);e.bind(b)()},this.addEventListener("contextmenu",function(a){a.preventDefault();y(this);e.bind(b)();return!1},!1),this.className+="st-clickable "})}null!=g&&(l.find("#st-tableSearchInput").change(function(){g.lastSearchTerm=this.value.trim();e.bind(b)()}),l.find("#st-tableSearchClear").click(function(){""!==
g.lastSearchTerm&&(g.lastSearchTerm="",e.bind(b)())}));null!=f&&(l.find("#st-tablePaginatePrevPageBtn").click(function(){f.currentPage--;e.bind(b)()}),l.find("#st-tablePaginateNextPageBtn").click(function(){f.currentPage++;e.bind(b)()}),l.find("#st-tableCurrentPage").change(function(){var a=this.value.trim(),a=$.isNumeric(a)?parseFloat(a):1;f.currentPage=a;e.bind(b)()}),l.find("#st-tableRowsDisplayInput").change(function(){var a=this.value.trim(),a=$.isNumeric(a)?parseFloat(a):5;f.rowsPerPage=a;r.rowsPerPage=
a;e.bind(b)()}));null!=k&&(k.selected={},l.find(".st-tableRowSet").addClass("clickable").click(function(){var a=$(this),b=[],d=!1;k.allowMultipleSelects||(k.selected={},d=a.hasClass("st-tableRowSetSelected"),$("#"+c.tableID+" .st-tableRowSet").removeClass("st-tableRowSetSelected"));d||(k.selectRowIndexes.forEach(function(c){var d=$(a[c]).find(".st-tableRowColumn");k.selectColumnIndexes.forEach(function(a){b.push(d[a].innerHTML.trim())})}),null==k.selected[b]?k.selected[b]=b:delete k.selected[b],a.toggleClass("st-tableRowSetSelected"));
if(null!=k.onClick)k.onClick(b)}).dblclick(function(){var a=$(this),b=[];k.selectRowIndexes.forEach(function(c){var d=$(a[c]).find(".st-tableRowColumn");k.selectColumnIndexes.forEach(function(a){b.push(d[a].innerHTML.trim())})});if(null!=k.onDblClick)k.onDblClick(b)}));a(l);this.onComplete=a}},update:function(){"rendering"!==this.dataset.tableRenderState&&(this.dataset.tableRenderState="rendering",this.render(function(a){$("#"+this.dataset.tableID).replaceWith(a);this.dataset.tableRenderState="idle"}.bind(this)));
...
return this}}}}},m=stencilTemplates.opts.templates;stencil.fetch(m.path+"/table"+m.stencilExt).progress(function(m){p.table.id=m.tagID;p.table.stencil=m}).done(function(){p.table.templateLoader.resolve()});stencilTemplates.table=p.table.builder})(); //# sourceMappingURL=table-1.0.0.st.min.map
